...
try:
    ...
    print(f"Module not found: {e}. Please make sure to install the required modules using:")
    print("pip install nltk scikit-learn")
    exit()

# Download necessary NLTK data files (only if they aren’t already downloaded)
nltk.download('punkt')
